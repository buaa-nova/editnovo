...
from ..depthcharge_modify.components.transformers import SpectrumEncoder, PeptideDecoder
from ..depthcharge_modify.components.SpectrumEncoderRefine import SpectrumEncoderRefine
    ...
    **kwargs : Dict
    ...
    def __init__(
        ...
        **kwargs: Dict,
        ...
        # )
        self.encoder = SpectrumEncoderRefine(
            dim_model=dim_model,
            n_head=n_head,
            dim_feedforward=dim_feedforward,
            n_layers=n_layers,
    ...
    def validation_step(
        ...
        for spectrum_preds in self._forward_step(batch[0], batch[1]):
    ...
    def predict_step(
        ...
        for (
            ...
            batch[2],
            self._forward_step(batch[0], batch[1]),
        ):
