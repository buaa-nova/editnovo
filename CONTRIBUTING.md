# Contributing to editnovo

First off, thank you for taking the time to contribute.

The following document provides guidelines for contributing to the
documentation and the code of editnovo. **No contribution is too small!** Even
...
3. The Code of Conduct, Release Notes, and this Contributing document are 
   markdown files that live in the root of the editnovo repository.
...
We welcome contributions to the source code of editnovo---particularly 
ones that address discussed [issues](https://github.com/buaa-nova/editnovo/issues).

Contributions to editnovo follow a standard GitHub contribution workflow:

1. Create your own fork of the editnovo repository on GitHub.

2. Clone your forked editnovo repository to work on locally.
...
6. On the GitHub page for you forked repository, click "Pull request" to propose
   adding your changes to editnovo.

7. We'll review, discuss, and help you make any revisions that are required. If
   all goes well, your changes will be added to editnovo
   in the next release!


### Python code style

The editnovo project follows the [PEP 8
...
format code and lint Python code in editnovo.
...
2. Navigate to your local copy of the editnovo repository and activate the hook:
```bash
pre-commit install
```
